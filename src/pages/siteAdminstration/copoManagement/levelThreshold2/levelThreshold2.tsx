        ...
        if (result.data !== "" && result.status === 200) {
          if (buttonClicked === "save") {
            Swal.fire({
              ...
              text: "Course outcomes threshold level set successfully.",
            });
            ...
            Swal.fire({
              ...
              background: "#e7eef5",
              showConfirmButton: false,
              text: "Course outcomes threshold level set successfully. Moving to the next step.",
            });
            setTimeout(() => {
              setActiveTab(3);
            }, 3000);
