...
const InstituteDepartmentDropdown = ({updateDepartmentFilter, currentInstitute, selectedValue, setSelectedValue}: any) => {
  ...
  const getCurrentValue = (e : any) => {
    updateDepartmentFilter(e.target.value);
  ...
  export default InstituteDepartmentDropdown;