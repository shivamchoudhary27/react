      ...
      <div>
        ...
        <form onSubmit={handleSubmit}>
          <div className="input-icons input-block mb-3">
            <i className="fa fa-circle-user icon"></i>
            <input
              type="text"
              autoComplete="off"
              name="fname"
            ...
            {touched.fname && errors.fname ? (
              <p className="form-error text-white">{errors.fname}</p>
            ) : null}
          </div>
          <div className="input-icons input-block mb-3">
            <i className="fa fa-circle-user icon"></i>
            ...
            {touched.lname && errors.lname ? (
              <p className="form-error text-white">{errors.lname}</p>
            ) : null}
          </div>
          <div className="input-icons input-block mb-3">
            ...
            {touched.email && errors.email ? (
              <p className="form-error text-white">{errors.email}</p>
            ) : null}
          </div>
          <div className="input-icons input-block">
            ...
            {touched.pass && errors.pass ? (
              <p className="form-error text-white">{errors.pass}</p>
            ) : null}
          </div>
          <div className="mt-4">
            <button
