                        ...
                        <tbody key={index}>
                          {
                            <tr>
                              ...
                              <td>
                                ...
                                <p>
                                  <strong>#{elem.id}</strong> Build Complete web
                                  and hybrid mobile solution. Master front end
                                  web, hybrid mobile app and server-side
                  ...
                  <div className="row text-end subtotal">
                    ...
                    <div className="col-sm-3">
                      <div className="subtotal_price">
                        <h5>
                          Subtotal :
                          <span className="fa-solid fa-indian-rupee-sign" />
                  ...
                  <div className="price_card">
                    ...
                    <div className="text-center">
                      <button className="btn btn-warning">
                        <span className="fa-solid fa-bag-shopping" /> Proceed to
                        Pay
                      </button>
                    </div>
                    ...
                    <div className="text-center">
                      <Link to="/catalogue" className="btn btn-dark">
                        <span className="fa-solid fa-basket-shopping" /> Continue
                        Shopping
                      </Link>
                    </div>
                  </div>
