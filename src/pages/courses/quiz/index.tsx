              ...
              <div>
                <div className="text-center">
                  {button.state === "inprogress" ? (
                    <Link
                      to={`/mod/attempt/quiz/${instance}/${button.attempt}/${courseid}`}
                              ...
                              <tr key={i}>
                                ...
                                {summarydata.state === "finished" && (
                                  <>
                                    ...
                                    <td>
                                      <Link
                                        to={`/mod/quiz/review/${summarydata.id}/${summarydata.quiz}/${courseid}`}
                                        state={{
                                          modnames: location.state != null ? modules.modname : nav.modname
                                        }}
