...
const MyTimetableDraftTable = ({ SlotData, courseDates, updateTimetableDates, toggleModalShow,handleMonthFilter,setChangeFilterStatus }: any) => {
...
export default MyTimetableDraftTable;
